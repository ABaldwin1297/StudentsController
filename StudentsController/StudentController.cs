    ...
    public class StudentController {
        ...
        public bool ChangeStudent(Student student) {
            var sql = "UPDATE Student SET "
                  + $" Firstname = '{student.Firstname}', Lastname = '{student.Lastname}', StateCode = '{student.StateCode}', SAT = {student.SAT}, GPA = {student.GPA}, MajorId = {student.MajorId} Where Id = {student.Id};";
        ...
        public bool AddStudent(Student student) {
            ...
            var sql = "INSERT Student"
                    ...
                    + " VALUES "
                    + $" ( '{student.Firstname}', '{student.Lastname}', '{student.StateCode}', {student.SAT}, {student.GPA}, {student.MajorId}) ";
            var cmd = new SqlCommand(sql, SqlConnection);
            var rowsAffected = cmd.ExecuteNonQuery();
            if (rowsAffected != 1) {
